...
public class ChessServiceTest {
    ...
    private static final Connection UNUSED_CONNECTION = null;
    ...
    void initializeChessAndLoadTurnTest() {
        chessService.initializeChess(UNUSED_CONNECTION, CHESS_ROOM_ID);

        Team actualTurn = chessService.loadTurn(UNUSED_CONNECTION, CHESS_ROOM_ID);
    ...
    void initializeChessAndLoadPiecesTest() {
        chessService.initializeChess(UNUSED_CONNECTION, CHESS_ROOM_ID);
        Board board = chessService.loadPieces(UNUSED_CONNECTION, CHESS_ROOM_ID);
